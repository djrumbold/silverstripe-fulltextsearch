    ...
    public static function solr_options()
    {
        ...
        if (version_compare($version, '4', '>=')) {
            $versionDefaults = array(
                'service' => 'SilverStripe\FullTextSearch\Solr\Solr4Service',
            ...
            $versionDefaults = array(
                'service' => 'SilverStripe\FullTextSearch\Solr\Solr3Service',
...
class Solr_BuildTask extends BuildTask
{
    ...
    {
        return Injector::inst()->get('SilverStripe\FullTextSearch\Utils\Logging\MonologFactory');
    }
